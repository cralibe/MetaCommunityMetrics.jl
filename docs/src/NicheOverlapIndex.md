...
To capture the changes in density-independent abiotic response, also known as niche breadth, this implementation is developed based on Pianka's Niche Overlap Index, as suggested by Pianka (1973). By returning both a summary (the mean, minimum, and maximum values of the pairwise niche overlap index across all species pairs) and the full distribution of pairwise niche overlap values, this function provides a comprehensive understanding of niche sharing within the community.
